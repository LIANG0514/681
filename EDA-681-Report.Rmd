...
hist(Florida_2008$X2008.week.total)
boxplot(Florida_2008$X2008.week.total)
boxplot.stats(Florida_2008$X2008.week.total)
ggplot(data=Florida_2008, aes(x=Florida_2008$X2008.week.total))+geom_density(kernel="gaussian", fill="lightblue")
plot(density(Florida_2008$X2008.week.total, colors="lightblue"))
...
hist(Florida_2011$X2011.week.total)
boxplot(Florida_2011$X2011.week.total)
...
plot(density(Florida_2011$X2011.week.total))
...
hist(Florida_2014$X2014.week.total)
boxplot(Florida_2014$X2014.week.total)
boxplot.stats(Florida_2014$X2014.week.total)
ggplot(data=Florida_2014, aes(x=Florida_2014$X2014.week.total))+geom_density(kernel="gaussian", fill="grey")
plot(density(Florida_2014$X2014.week.total))
